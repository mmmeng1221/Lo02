...
public class Part extends Observable{
    ...
    public void initialiserCarte() throws IOException{
        ...
        file = new File("src/Image/Guide/Martyr 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Guide/Martyr 3.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Guide/Clerc 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_SYMBOLES);
        dogs.add(Constants.DOGMES_NATURE);
        file = new File("src/Image/Guide/Clerc 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Guide/Clerc 3.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_CHAOS);
        dogs.add(Constants.DOGMES_NATURE);
        file = new File("src/Image/Guide/Clerc 4.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_SYMBOLES);
        dogs.add(Constants.DOGMES_MYSTIQUES);
        file = new File("src/Image/Guide/Clerc 5.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_SYMBOLES);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Guide/Clerc 6.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_MYSTIQUES);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Guide/Clerc 7.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_NATURE);
        file = new File("src/Image/Guide/Clerc 8.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_MYSTIQUES);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Moines 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_MYSTIQUES);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Travailleurs 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_MYSTIQUES);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Travailleurs 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_MYSTIQUES);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Travailleurs 3.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Ermite 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_SYMBOLES);
        file = new File("src/Image/Croyant/Guerriers Saints.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Alchimistes 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_SYMBOLES);
        file = new File("src/Image/Croyant/Vampire 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Vampire 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Lycanthropes 1.jpg");
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
            e.printStackTrace();
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Illusionnistes 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_MYSTIQUES);
        file = new File("src/Image/Croyant/Esprits 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Alienes 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_SYMBOLES);
        file = new File("src/Image/Croyant/Alienes 3.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Alienes 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_MYSTIQUES);
        file = new File("src/Image/Croyant/Revenant 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_NATURE);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Alchimistes 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        dogs.add(Constants.DOGMES_HUMAIN);
        dogs.add(Constants.DOGMES_CHAOS);
        file = new File("src/Image/Croyant/Revolutionnaires 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        //DeusEx
        file = new File("src/Image/DeuxEx/Colere Divine 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/DeuxEx/Colere Divine 2.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/DeuxEx/Ordre Celeste 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/DeuxEx/Fourberie 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/DeuxEx/Diversion 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/DeuxEx/Concentration 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/DeuxEx/Phoenix 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
         ...
         * Apocalypse
         */
        file = new File("src/Image/Apocalypse/Apocalypse 1.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Killinstred.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Ilenella.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Pni-Tara.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Gnenghelen.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Shingva.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Gorpa.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Rontec.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
        ...
        file = new File("src/Image/Divinite/Divinite Drinded.jpg");
        image = null;
        try {
            image = ImageIO.read(file);
        } catch (IOException e) {
...
/*System.out.println(cartePioche.size());*/
    ...
    public /*List<Divinite>*/void shuffleDivi() {
        Divinite temp1, temp2;
        Date date = new Date(System.currentTimeMillis());
        Random random = new Random();
        random.setSeed(date.getTime());
        for (int i = 0; i < 10; i++) {
            temp1 = this.carteDivi.get(random.nextInt(7));
            this.carteDivi.remove(temp1);
            this.carteDivi.add(temp1);

            temp2 = this.carteDivi.get(random.nextInt(3));
    ...
    public void piocher(List<Joueur> listeJouCourant) {
        for (Joueur j : listeJouCourant)
            for (int i = 0; i < 7; i++) {
                ...
                this.cartePioche.remove(i);
            }
    }

    public Carte piocher1Carte() {
        Carte carte = this.cartePioche.get(0);
        this.cartePioche.remove(carte);
        return carte;
    }
